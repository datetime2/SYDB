(function ($) {
    $.nfinetab = {
        ...
        refreshTab: function () {
            ...
            var target = $('.SAAS_iframe[data-id="' + currentId + '"]');
        ...
        activeTab: function () {
            ...
            if (!$(this).hasClass('active')) {
                $('.mainContent .SAAS_iframe').each(function () {
                    if ($(this).data('id') == currentId) {
                        $(this).show().siblings('.SAAS_iframe').hide();
                        return false;
                    }
                });
        ...
        closeOtherTabs: function () {
            $('.page-tabs-content').children("[data-id]").find('.fa-remove').parents('a').not(".active").each(function () {
                $('.SAAS_iframe[data-id="' + $(this).data('id') + '"]').remove();
                $(this).remove();
            });
        ...
        addTab: function () {
            ...
            if (dataId != "") {
                top.$.cookie('saas_currentab', dataId, { path: "/" });
            }
            ...
            if (flag) {
                ...
                var str1 = '<iframe class="SAAS_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
                $('.mainContent').find('iframe.SAAS_iframe').hide();
        ...
        init: function () {
            ...
            $('.tabCloseAll').on('click', function () {
                ...
                $('.page-tabs-content').children("[data-id]:first").each(function () {
                    $('.SAAS_iframe[data-id="' + $(this).data('id') + '"]').show();
